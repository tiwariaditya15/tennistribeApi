...
var toggleReaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId_1, postId, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!result.likedBy.some(function (user) { return user.id === userId_1; })) return [3 /*break*/, 3];
            ...
            case 4:
                _a.sent();
                _a.label = 5;
            case 5: return [2 /*return*/, res.status(200).json({ postId: postId, message: "Toggled reaction!" })];
            case 6:
                error_1 = _a.sent();
