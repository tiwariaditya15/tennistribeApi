...
var getComments = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, postId, comments, error_1;
...
var postComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, postId, comment, addedComment, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                addedComment = _b.sent();
                return [2 /*return*/, res.status(200).json({ addedComment: addedComment })];
            case 2:
                error_2 = _b.sent();
...
var deleteComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.sent();
                return [2 /*return*/, res.status(200).json({ message: "Removed comment!", postId: postId })];
            case 2:
                error_3 = _b.sent();
